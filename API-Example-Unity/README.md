...
| [ProcessAudioRawData](https://github.com/AgoraIO-Community/Agora-Unity-RTC-QuickStart-NG/tree/release/3.8.201/API-Example-Unity/Assets/API-Example/Examples/Advanced/ProcessAudioRawData) | process raw Audio data in rtc engine and play with audioclip                       | RegisterAudioFrameObserver, OnCaptureVideoFrame, OnRenderVideoFrame |
| [ProcessVideoRawData](https://github.com/AgoraIO-Community/Agora-Unity-RTC-QuickStart-NG/tree/release/3.8.201/API-Example-Unity/Assets/API-Example/Examples/Advanced/ProcessVideoRawData) | process raw Audio data in rtc engine and play with audioclip                       | RegisterAudioFrameObserver, OnCaptureVideoFrame, OnRenderVideoFrame |
