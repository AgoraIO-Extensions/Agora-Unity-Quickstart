...
namespace CustomAudioSinkSample
{
        ...
        private void PullAudioFrameThread()
        {
            ...
            while (_pullAudioFrameThreadSignal)
            {
                ...
                if (toc.Subtract(tic).Duration().Milliseconds >= freq)
                {
                    ...
                    AgoraRtcEngine.PullAudioFrame(audioFrame);
    ...
    {
        private readonly CustomAudioSinkSample _customAudioSinkSample;
        
        internal UserEventHandler(CustomAudioSinkSample customAudioSinkSample)
        {
        ...
        public override void OnJoinChannelSuccess(string channelName, uint uid, int elapsed)
        {
            ...
            _customAudioSinkSample.Logger.UpdateLog(string.Format("onJoinChannelSuccess channelName: {0}, uid: {1}, elapsed: {2}", channelName,
                uid, elapsed));
        }
