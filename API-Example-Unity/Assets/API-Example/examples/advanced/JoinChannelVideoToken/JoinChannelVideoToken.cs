...
public class JoinChannelVideoToken : MonoBehaviour {
    ...
    private static string channelToken = "006ff6fcd30217d4f04a96e0f12a4d75c79IAA5EUViTOhO7av/SaS2xjHtbn3QrB3Vuo4J38bKFs5l+NJjSIgAAAAAEADnwT+sj6luYQEAAQCOqW5h";
    ...
    internal class UserEventHandler : IAgoraRtcEngineEventHandler
    {
        ...
        public override void OnJoinChannelSuccess(RtcConnection connection, int elapsed)
        {
            ...
            _helloVideoTokenAgora.Logger.UpdateLog(string.Format("New Token: {0}", JoinChannelVideoToken.channelToken));
        ...
        {
            _helloVideoTokenAgora.StartCoroutine(HelperClass.FetchToken(tokenBase, _helloVideoTokenAgora.channelName, 0, _helloVideoTokenAgora.RenewOrJoinToken));
        }
