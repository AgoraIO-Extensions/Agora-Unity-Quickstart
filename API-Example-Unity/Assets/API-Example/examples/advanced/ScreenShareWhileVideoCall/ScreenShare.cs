...
namespace ScreenShare
{
    ...
    internal class UserEventHandler : IAgoraRtcEngineEventHandler
    {
        ...
        internal UserEventHandler(ScreenShare desktopScreenShare, AgoraEngineType agoraEngineType)
        {
        ...
        public override void OnJoinChannelSuccess(string channel, uint uid, int elapsed)
        {
            ...
            ScreenShare.MakeVideoView(_agoraEngineType, 0);
        }
        ...
        public override void OnLeaveChannel(RtcStats stats)
        {
            ...
            ScreenShare.DestroyVideoView(0, _agoraEngineType);
        }
        ...
        public override void OnUserJoined(uint uid, int elapsed)
        {
            ...
            if (_agoraEngineType == AgoraEngineType.MainProcess)
                ScreenShare.MakeVideoView(_agoraEngineType, uid, _desktopScreenShare.GetChannelName());
        }
        ...
        public override void OnUserOffline(uint uid, USER_OFFLINE_REASON_TYPE reason)
        {
            _desktopScreenShare.Logger.UpdateLog(string.Format("OnUserOffLine uid: ${0}, reason: ${1}", uid,
                (int) reason));
            if (_agoraEngineType == AgoraEngineType.MainProcess)
                ScreenShare.DestroyVideoView(uid, _agoraEngineType);
        }
