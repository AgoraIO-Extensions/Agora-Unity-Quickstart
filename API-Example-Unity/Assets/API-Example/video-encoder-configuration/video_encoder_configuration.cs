...
public class video_encoder_configuration : MonoBehaviour
{
    ...
    {
        private readonly video_encoder_configuration _videoEncoderConfiguration;

        internal UserEventHandler(video_encoder_configuration videoEncoderConfiguration)
        {
