...
public class MultiChannelSample : MonoBehaviour
{
     ...
     {
         private readonly MultiChannelSample _multiChannelSample;
         
         internal UserEventHandler1(MultiChannelSample multiChannelSample)
         {
     ...
     internal class UserEventHandler2 : IAgoraRtcChannelEventHandler
     {
         ...
         internal UserEventHandler2(MultiChannelSample multiChannelSample)
         {
             _multiChannelSample = multiChannelSample;
         }
