...
namespace io.agora.rtm.demo
{
    public class RtmClientComponent : IRtmComponet
    {
        ...
        {
            RtmScene.AddMessage("OnMessageEvent channelName : " + @event.channelName + " channelTopic :" + @event.channelTopic + " channelType : " + @event.channelType + " publisher : " + @event.publisher + " message : " + @event.message, Message.MessageType.TopicMessage);
        }
