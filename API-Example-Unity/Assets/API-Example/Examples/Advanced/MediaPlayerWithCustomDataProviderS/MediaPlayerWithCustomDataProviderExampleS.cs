...
namespace Agora_RTC_Plugin.API_Example.Examples.Advanced.MediaPlayerWithCustomDataProviderExampleS
{
    public class MediaPlayerWithCustomDataProviderExampleS : MonoBehaviour
    {
    ...
    {
        private readonly MediaPlayerWithCustomDataProviderExampleS _sample;

        internal MpkEventHandler(MediaPlayerWithCustomDataProviderExampleS sample)
        {
            _sample = sample;
        }
        ...
        public override void OnPlayerSourceStateChanged(MEDIA_PLAYER_STATE state, MEDIA_PLAYER_ERROR ec)
        {
            ...
            {
                MediaPlayerWithCustomDataProviderExampleS.MakeVideoView(_sample.MediaPlayer.GetId().ToString(), "", VIDEO_SOURCE_TYPE.VIDEO_SOURCE_MEDIA_PLAYER);
            ...
            {
                MediaPlayerWithCustomDataProviderExampleS.DestroyVideoView(_sample.MediaPlayer.GetId().ToString());
    ...
    internal class UserEventHandlerS : IRtcEngineEventHandlerS
    {
        ...
        internal UserEventHandlerS(MediaPlayerWithCustomDataProviderExampleS sample)
        {
            _sample = sample;
        }
        ...
        public override void OnLeaveChannel(RtcConnectionS connection, RtcStats stats)
        {
            ...
            MediaPlayerWithCustomDataProviderExampleS.DestroyVideoView("");
        }
    ...
    internal class UserPlayerCustomDataProvider : IMediaPlayerCustomDataProvider
    {
        ...
        MediaPlayerWithCustomDataProviderExampleS _sample;
        private FileStream fis = null;

        private Int64 fileSize = 0;


        internal UserPlayerCustomDataProvider(MediaPlayerWithCustomDataProviderExampleS sample)
        {
            _sample = sample;
