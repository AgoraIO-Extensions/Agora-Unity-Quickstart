...
namespace Agora_RTC_Plugin.API_Example.Examples.Advanced.MusicPlayerS
{
    public class MusicPlayerExampleS : MonoBehaviour
    {
        ...
        public void OnOpenButtonClick()
        {
            ...
            MusicPlayerExampleS.MakeVideoView(MusicPlayer.GetId().ToString(), "", VIDEO_SOURCE_TYPE.VIDEO_SOURCE_MEDIA_PLAYER);
        }
    ...
    {
        private readonly MusicPlayerExampleS _sample;

        internal UserEventHandlerS(MusicPlayerExampleS sample)
        {
            _sample = sample;
        }
        ...
        public override void OnLeaveChannel(RtcConnectionS connection, RtcStats stats)
        {
            ...
            MusicPlayerExampleS.DestroyVideoView("");
        }
        ...
        public override void OnUserOffline(RtcConnectionS connection, string userAccount, USER_OFFLINE_REASON_TYPE reason)
        {
            _sample.Log.UpdateLog(string.Format("OnUserOffLine uid: ${0}, reason: ${1}", userAccount,
                (int)reason));
            MusicPlayerExampleS.DestroyVideoView(userAccount);
        }
    }

    internal class UserMusicContentCenterEventHandler : IMusicContentCenterEventHandler
    {
        private MusicPlayerExampleS _sample;

        internal UserMusicContentCenterEventHandler(MusicPlayerExampleS sample)
        {
            this._sample = sample;
        }
    ...
    internal class MpkEventHandler : IMediaPlayerSourceObserver
    {
        ...
        internal MpkEventHandler(MusicPlayerExampleS sample)
        {
            _sample = sample;
        }
