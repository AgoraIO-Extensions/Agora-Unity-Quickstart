...
在实现屏幕共享前，请确保已在你的项目中实现基本的实时音视频功能。详见[开始音视频通话](https://docs.agora.io/cn/video-legacy/Video/start_call_react_native?platform=React Native)或[开始互动直播](https://docs.agora.io/cn/video-legacy/Interactive Broadcast/start_live_react_native?platform=React Native)。
