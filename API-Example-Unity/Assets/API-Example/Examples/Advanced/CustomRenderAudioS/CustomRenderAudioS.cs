...
namespace Agora_RTC_Plugin.API_Example.Examples.Advanced.CustomRenderAudioS
{
    public class CustomRenderAudioS : MonoBehaviour
    {
        ...
        private void PullAudioFrameThread()
        {
            ...
            AudioFrame audioFrame = new AudioFrame(type, samples, BYTES_PER_SAMPLE.TWO_BYTES_PER_SAMPLE, channels, samplesPerSec, IntPtr.Zero, 0, avsync_type,0,0);
    ...
    {
        private readonly CustomRenderAudioS _customAudioSinkSample;

        internal UserEventHandlerS(CustomRenderAudioS customAudioSinkSample)
        {
