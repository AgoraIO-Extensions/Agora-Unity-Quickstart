...
namespace Agora_RTC_Plugin.API_Example.Examples.Advanced.StartRtmpStreamWithTranscodingS
{
    public class StartRtmpStreamWithTranscodingS : MonoBehaviour
    {
        ...
        private void OnStartButtonPress()
        {
            ...
            var liveTranscoding = new LiveTranscodingS();
            liveTranscoding.userCount = 1;
            liveTranscoding.transcodingUsersS = new TranscodingUserS[1];
            liveTranscoding.transcodingUsersS[0] = new TranscodingUserS()
            {
    ...
    {
        private readonly StartRtmpStreamWithTranscodingS _sample;

        internal UserEventHandlerS(StartRtmpStreamWithTranscodingS sample)
        {
            _sample = sample;
        }
        ...
        public override void OnJoinChannelSuccess(RtcConnectionS connection, int elapsed)
        {
            ...
            _sample.Uid = connection.localUserAccount;
            StartRtmpStreamWithTranscodingS.MakeVideoView("");
        }
        ...
        public override void OnLeaveChannel(RtcConnectionS connection, RtcStats stats)
        {
            ...
            StartRtmpStreamWithTranscodingS.DestroyVideoView("");
        }
        ...
        public override void OnUserJoined(RtcConnectionS connection, string userAccount, int elapsed)
        {
            ...
            StartRtmpStreamWithTranscodingS.MakeVideoView(userAccount, _sample.GetChannelName());
        }
        ...
        public override void OnUserOffline(RtcConnectionS connection, string userAccount, USER_OFFLINE_REASON_TYPE reason)
        {
            _sample.Log.UpdateLog(string.Format("OnUserOffLine uid: ${0}, reason: ${1}", userAccount,
                (int)reason));
            StartRtmpStreamWithTranscodingS.DestroyVideoView(userAccount);
        }
