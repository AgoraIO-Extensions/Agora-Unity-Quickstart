...
namespace Agora_RTC_Plugin.API_Example.Examples.Advanced.MediaPlayerS
{
    public class MediaPlayerExampleS : MonoBehaviour
    {
    ...
    {
        private readonly MediaPlayerExampleS _sample;

        internal MpkEventHandler(MediaPlayerExampleS sample)
        {
            _sample = sample;
        }
        ...
        public override void OnPlayerSourceStateChanged(MEDIA_PLAYER_STATE state, MEDIA_PLAYER_ERROR ec)
        {
            ...
            {
                MediaPlayerExampleS.MakeVideoView(_sample.MediaPlayer.GetId().ToString(), "", VIDEO_SOURCE_TYPE.VIDEO_SOURCE_MEDIA_PLAYER);
            ...
            {
                MediaPlayerExampleS.DestroyVideoView(_sample.MediaPlayer.GetId().ToString());
    ...
    internal class UserEventHandlerS : IRtcEngineEventHandlerS
    {
        ...
        internal UserEventHandlerS(MediaPlayerExampleS sample)
        {
            _sample = sample;
        }
        ...
        public override void OnLeaveChannel(RtcConnectionS connection, RtcStats stats)
        {
            ...
            MediaPlayerExampleS.DestroyVideoView("");
        }
        ...
        public override void OnUserOffline(RtcConnectionS connection, string userAccount, USER_OFFLINE_REASON_TYPE reason)
        {
            _sample.Log.UpdateLog(string.Format("OnUserOffLine uid: ${0}, reason: ${1}", userAccount,
                (int)reason));
            MediaPlayerExampleS.DestroyVideoView(userAccount);
        }
    }
