...
namespace Agora_RTC_Plugin.API_Example.Examples.Advanced.MediaRecorderS
{
    public class MediaRecorderS : MonoBehaviour
    {
        ...
        internal IMediaRecorderS LocalRecorder = null;
        ...
        private void JoinChannel()
        {
            ...
            var ret = RtcEngine.JoinChannel(_token, _channelName, "123", options);
    ...
    {
        private readonly MediaRecorderS _sample;

        internal UserEventHandlerS(MediaRecorderS sample)
        {
            _sample = sample;
        }
        ...
        public override void OnJoinChannelSuccess(RtcConnectionS connection, int elapsed)
        {
            ...
            _sample.LocalRecorder = _sample.RtcEngine.CreateMediaRecorder(new RecorderStreamInfoS(connection.channelId, connection.localUserAccount));
            _sample.LocalRecorder.SetMediaRecorderObserver(new MediaRecorderObserverS(_sample));
            _sample.EnableUI(true);
            MediaRecorderS.MakeVideoView("");
        ...
        public override void OnLeaveChannel(RtcConnectionS connection, RtcStats stats)
        {
            ...
            MediaRecorderS.DestroyVideoView("");
        }
    ...
    internal class MediaRecorderObserverS : IMediaRecorderObserverS
    {
        private readonly MediaRecorderS _sample;

        internal MediaRecorderObserverS(MediaRecorderS sample)
        {
            _sample = sample;
        }

        public override void OnRecorderInfoUpdated(string channelId, string userAccount, RecorderInfo info)
        {
        ...
        public override void OnRecorderStateChanged(string channelId, string userAccount, RecorderState state, RecorderErrorCode error)
        {
