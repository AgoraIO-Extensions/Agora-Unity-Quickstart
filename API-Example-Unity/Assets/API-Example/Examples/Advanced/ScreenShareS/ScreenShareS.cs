...
namespace Agora_RTC_Plugin.API_Example.Examples.Advanced.ScreenShareS
{
    public class ScreenShareS : MonoBehaviour
    {
        ...
        {
            var ret = RtcEngine.JoinChannel(_token, _channelName, "", "123");
        ...
        public void OnStartShareBtnClick()
        {
            ...
            ScreenShareS.MakeVideoView("", "", VIDEO_SOURCE_TYPE.VIDEO_SOURCE_SCREEN);
    ...
    {
        private readonly ScreenShareS _desktopScreenShare;

        internal UserEventHandlerS(ScreenShareS desktopScreenShare)
        {
        ...
        public override void OnLeaveChannel(RtcConnectionS connection, RtcStats stats)
        {
            ...
            ScreenShareS.DestroyVideoView(connection.localUserAccount);
        }
        ...
        {
            _desktopScreenShare.Log.UpdateLog(string.Format("OnUserJoined uid: ${0} elapsed: ${1}", userAccount, elapsed));
            ScreenShareS.MakeVideoView(userAccount, _desktopScreenShare.GetChannelName(), VIDEO_SOURCE_TYPE.VIDEO_SOURCE_REMOTE);
        }
        ...
        public override void OnUserOffline(RtcConnectionS connection, string userAccount, USER_OFFLINE_REASON_TYPE reason)
        {
            _desktopScreenShare.Log.UpdateLog(string.Format("OnUserOffLine uid: ${0}, reason: ${1}", userAccount,
                (int)reason));
            ScreenShareS.DestroyVideoView(userAccount);
        }
    }
