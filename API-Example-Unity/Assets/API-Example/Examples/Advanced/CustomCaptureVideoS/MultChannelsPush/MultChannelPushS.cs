...
namespace Agora_RTC_Plugin.API_Example.Examples.Advanced.MultChannelPushS
{
    public class MultChannelPushS : MonoBehaviour
    {
        ...
        private string _uid1 = "123";
        private string _uid2 = "456";
        ...
        private void JoinChannel1()
        {
            ...
            RtcEngine.JoinChannelEx("", new RtcConnectionS(_channelName, _uid1), channelMediaOptions);

            VideoEncoderConfiguration videoEncoderConfiguration = new VideoEncoderConfiguration();
            videoEncoderConfiguration.dimensions = new VideoDimensions((int)_rect1.width, (int)_rect1.height);
            RtcEngine.SetVideoEncoderConfigurationEx(videoEncoderConfiguration, new RtcConnectionS(_channelName, _uid1));
        }
        ...
        private void JoinChannel2()
        {
            ...
            channelMediaOptions.clientRoleType.SetValue(CLIENT_ROLE_TYPE.CLIENT_ROLE_BROADCASTER);
            RtcEngine.JoinChannelEx("", new RtcConnectionS(_channelName, _uid2), channelMediaOptions);

            VideoEncoderConfiguration videoEncoderConfiguration = new VideoEncoderConfiguration();
            videoEncoderConfiguration.dimensions = new VideoDimensions((int)_rect2.width, (int)_rect2.height);
            RtcEngine.SetVideoEncoderConfigurationEx(videoEncoderConfiguration, new RtcConnectionS(_channelName, _uid2));
        }
    ...
    {
        private readonly MultChannelPushS _sample;

        internal UserEventHandlerS(MultChannelPushS sample)
        {
            _sample = sample;
        }
        ...
        public override void OnUserJoined(RtcConnectionS connection, string userAccount, int elapsed)
        {
            ...
            MultChannelPushS.MakeVideoView(userAccount, _sample.GetChannelName());
        }
        ...
        public override void OnUserOffline(RtcConnectionS connection, string userAccount, USER_OFFLINE_REASON_TYPE reason)
        {
            _sample.Log.UpdateLog(string.Format("OnUserOffLine uid: ${0}, reason: ${1}", userAccount,
                (int)reason));
            MultChannelPushS.DestroyVideoView(userAccount);
        }
    }
