...
namespace Agora_RTC_Plugin.API_Example.Examples.Advanced.CustomCaptureVideoS
{
    public class CustomCaptureVideoS : MonoBehaviour
    {
    ...
    {
        private readonly CustomCaptureVideoS _customCaptureVideo;

        internal UserEventHandlerS(CustomCaptureVideoS customCaptureVideo)
        {
        ...
        public override void OnUserJoined(RtcConnectionS connection, string userAccount, int elapsed)
        {
            ...
            CustomCaptureVideoS.MakeVideoView(userAccount, _customCaptureVideo.GetChannelName());
        }

        public override void OnUserOffline(RtcConnectionS connection, string userAccount, USER_OFFLINE_REASON_TYPE reason)
        {
            _customCaptureVideo.Log.UpdateLog(string.Format("OnUserOffLine uid: ${0}, reason: ${1}", userAccount,
                (int)reason));
            CustomCaptureVideoS.DestroyVideoView(userAccount);
        }
    }
