...
namespace Agora_RTC_Plugin.API_Example.Examples.Advanced.PluginSceneSampleS
{
    using PluginSamplePtr = IntPtr;
    using RtcEnginePtr = IntPtr;
    public class PluginSceneSampleS : MonoBehaviour
    {
    ...
    {
        private readonly PluginSceneSampleS _sample;

        internal UserEventHandlerS(PluginSceneSampleS videoSample)
        {
            _sample = videoSample;
        }
        ...
        public override void OnJoinChannelSuccess(RtcConnectionS connection, int elapsed)
        {
            ...
            PluginSceneSampleS.MakeVideoView("");
        }
        ...
        public override void OnLeaveChannel(RtcConnectionS connection, RtcStats stats)
        {
            ...
            PluginSceneSampleS.DestroyVideoView("");
        }
        ...
        public override void OnUserJoined(RtcConnectionS connection, string userAccount, int elapsed)
        {
            ...
            PluginSceneSampleS.MakeVideoView(userAccount, _sample.GetChannelName());
        }
        ...
        public override void OnUserOffline(RtcConnectionS connection, string userAccount, USER_OFFLINE_REASON_TYPE reason)
        {
            _sample.Log.UpdateLog(string.Format("OnUserOffLine userAccount: ${0}, reason: ${1}", userAccount,
                (int)reason));
            PluginSceneSampleS.DestroyVideoView(userAccount);
        }
