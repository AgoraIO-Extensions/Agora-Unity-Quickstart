...
namespace Agora_RTC_Plugin.API_Example.Examples.Advanced.SetBeautyEffectOptionsS
{
    public class SetBeautyEffectOptionsS : MonoBehaviour
    {
    ...
    {
        private readonly SetBeautyEffectOptionsS _sample;

        internal UserEventHandlerS(SetBeautyEffectOptionsS sample)
        {
            _sample = sample;
        }
        ...
        public override void OnJoinChannelSuccess(RtcConnectionS connection, int elapsed)
        {
            ...
            SetBeautyEffectOptionsS.MakeVideoView("");
        }
        ...
        public override void OnLeaveChannel(RtcConnectionS connection, RtcStats stats)
        {
            ...
            SetBeautyEffectOptionsS.DestroyVideoView("");
        }
        ...
        public override void OnUserJoined(RtcConnectionS connection, string userAccount, int elapsed)
        {
            ...
            SetBeautyEffectOptionsS.MakeVideoView(userAccount, _sample.GetChannelName());
        }
        ...
        public override void OnUserOffline(RtcConnectionS connection, string userAccount, USER_OFFLINE_REASON_TYPE reason)
        {
            _sample.Log.UpdateLog(string.Format("OnUserOffLine uid: ${0}, reason: ${1}", userAccount,
                (int)reason));
            SetBeautyEffectOptionsS.DestroyVideoView(userAccount);
        }
    }
