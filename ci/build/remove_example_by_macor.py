...
number_example_list = [
    ...
    "API-Example/Examples/Advanced/MediaPlayerOpenWithMediaSource",
    ...
    "API-Example/Examples/Advanced/RenderWithRGBA",
...
string_example_list = [
    ...
    "API-Example/Examples/Advanced/MediaPlayerOpenWithMediaSourceS",
    ...
    "API-Example/Examples/Advanced/RenderWithRGBAS",
...
video_example_list = [
    ...
    {'dir_name': 'API-Example/Examples/Advanced/RenderWithRGBA', 'scene_name': 'RenderWithRGBA'},
    {'dir_name': 'API-Example/Examples/Advanced/RenderWithRGBAS', 'scene_name': 'RenderWithRGBAS'},
